...
public class EmployeeRepositoryTests {
    ...
    @BeforeEach
    public void setUp()  {
        em.persist(new Employee(-1, "Employee1", 10_000, "Sørlandet"));
        em.persist(new Employee(-1, "Employee2", 20_000, "Østlandet"));
        em.persist(new Employee(-1, "Employee3", 30_000, "Vestlandet"));
        em.persist(new Employee(-1, "Employee4", 40_000, "Trøndelag"));
        em.persist(new Employee(-1, "Employee5", 50_000, "Sørlandet"));
        em.persist(new Employee(-1, "Employee6", 60_000, "Østlandet"));
        em.persist(new Employee(-1, "Employee7", 70_000, "Vestlandet"));
        em.persist(new Employee(-1, "Employee8", 80_000, "Trøndelag"));
    }
